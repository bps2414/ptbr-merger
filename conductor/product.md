...
- **Audio Extraction & Merging:** Uses FFmpeg native wrappers to extract the Portuguese audio from the 1080p source and multiplex (mix) it into the 4K target file.
